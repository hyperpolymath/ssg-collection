...
[arabic]
. Navigate to
https://github.com/hyperpolymath/doit-ssg/security/advisories/new[Report
a Vulnerability]
...
For non-critical security concerns, you may open a GitHub issue with the
`+security+` label.

____
*Important:* Do not report critical security vulnerabilities through
...
https://github.com/hyperpolymath/doit-ssg/security/advisories[Security
Advisories]
...
|*General questions*
|https://github.com/hyperpolymath/doit-ssg/discussions[GitHub
Discussions]
...
_Thank you for helping keep doit-ssg and its users safe._
