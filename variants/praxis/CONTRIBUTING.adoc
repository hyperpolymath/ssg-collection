...
git clone https://github.com/hyperpolymath/praxis-ssg.git cd praxis-ssg
...
toolbox create praxis-ssg-dev toolbox enter praxis-ssg-dev # Install
...
praxis-ssg/ ├── src/ # Source code (Perimeter 1-2) ├── lib/ # Library
