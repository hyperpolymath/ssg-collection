...
doit-ssg a harassment-free experience for everyone, regardless of age,
...
|*GitHub Issue* |Open a private security advisory or issue |Detailed
reports
...
. *Open a GitHub issue* or contact maintainers with subject "`Appeal:
[Original Report ID]`"
...
* Open a
https://github.com/hyperpolymath/doit-ssg/discussions[Discussion] (for
general questions)
