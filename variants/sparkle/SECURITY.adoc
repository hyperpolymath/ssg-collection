...
[arabic]
. Navigate to
https://github.com/hyperpolymath/sparkle-ssg/security/advisories/new[Report
a Vulnerability]
...
GitHub issues, pull requests, discussions, or social media. Use GitHub
Security Advisories exclusively.
____
...
https://github.com/hyperpolymath/sparkle-ssg/security/advisories[Security
Advisories]
...
|*General questions*
|https://github.com/hyperpolymath/sparkle-ssg/discussions[GitHub
Discussions]
...
_Thank you for helping keep Sparkle-SSG and its users safe._ 🛡️
