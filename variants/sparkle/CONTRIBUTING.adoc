...
git clone https://github.com/hyperpolymath/sparkle-ssg.git cd
sparkle-ssg
...
toolbox create sparkle-ssg-dev toolbox enter sparkle-ssg-dev # Install
...
sparkle-ssg/ ├── src/ # Source code (Perimeter 1-2) ├── lib/ # Library
