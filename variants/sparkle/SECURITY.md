...
1. Navigate to [Report a Vulnerability](https://github.com/hyperpolymath/sparkle-ssg/security/advisories/new)
...
> **⚠️ Important:** Do not report security vulnerabilities through public GitHub issues, pull requests, discussions, or social media. Use GitHub Security Advisories exclusively.
...
- This repository (`hyperpolymath/sparkle-ssg`) and all its code
...
- **GitHub Security Advisories**: Published at [Security Advisories](https://github.com/hyperpolymath/sparkle-ssg/security/advisories)
...
When using Sparkle-SSG, we recommend:
...
- [Security Advisories](https://github.com/hyperpolymath/sparkle-ssg/security/advisories)
...
| Purpose | Contact |
|---------|---------|
| **Security issues** | [Report via GitHub Security Advisories](https://github.com/hyperpolymath/sparkle-ssg/security/advisories/new) |
| **General questions** | [GitHub Discussions](https://github.com/hyperpolymath/sparkle-ssg/discussions) |
...
*Thank you for helping keep Sparkle-SSG and its users safe.* 🛡️
