...
1. Navigate to [Report a Vulnerability](https://github.com/hyperpolymath/orbital-ssg/security/advisories/new)
...
If you cannot use GitHub Security Advisories, you may contact maintainers through [GitHub Discussions](https://github.com/hyperpolymath/orbital-ssg/discussions) with a request for private contact.
...
- This repository (`hyperpolymath/orbital-ssg`) and all its code
...
- **GitHub Security Advisories**: Published at [Security Advisories](https://github.com/hyperpolymath/orbital-ssg/security/advisories)
...
When using orbital-ssg, we recommend:
...
- [Security Advisories](https://github.com/hyperpolymath/orbital-ssg/security/advisories)
...
| Purpose | Contact |
|---------|---------|
| **Security issues** | [Report via GitHub](https://github.com/hyperpolymath/orbital-ssg/security/advisories/new) |
| **General questions** | [GitHub Discussions](https://github.com/hyperpolymath/orbital-ssg/discussions) |
...
*Thank you for helping keep orbital-ssg and its users safe.* 🛡️
