...
[arabic]
. Navigate to
https://github.com/hyperpolymath/orbital-ssg/security/advisories/new[Report
a Vulnerability]
...
If you cannot use GitHub Security Advisories, you may contact
maintainers through
https://github.com/hyperpolymath/orbital-ssg/discussions[GitHub
Discussions] with a request for private contact.
...
https://github.com/hyperpolymath/orbital-ssg/security/advisories[Security
Advisories]
...
_Thank you for helping keep orbital-ssg and its users safe._ 🛡️
