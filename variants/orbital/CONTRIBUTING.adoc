...
git clone https://github.com/hyperpolymath/orbital-ssg.git cd
orbital-ssg
...
toolbox create orbital-ssg-dev toolbox enter orbital-ssg-dev # Install
...
orbital-ssg/ ├── src/ # Source code (Perimeter 1-2) ├── lib/ # Library
