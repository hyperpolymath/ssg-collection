...
[arabic]
. Navigate to
https://github.com/hyperpolymath/baremetal-ssg/security/advisories/new[Report
a Vulnerability]
...
GitHub issues, pull requests, discussions, or social media. Use the
GitHub Security Advisories feature above.
____
...
https://github.com/hyperpolymath/baremetal-ssg/security/advisories[Security
Advisories]
...
|*General questions*
|https://github.com/hyperpolymath/baremetal-ssg/discussions[GitHub
Discussions]
...
_Thank you for helping keep baremetal-ssg and its users safe._ 🛡️
