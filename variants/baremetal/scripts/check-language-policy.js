...
//
// baremetal-ssg Language Policy Enforcement
// This SSG MUST be written in RISC-V Assembly - no exceptions

const fs = require("fs");
const path = require("path");

const CORE_LANGUAGE = "RISC-V Assembly";
const CORE_EXTENSIONS = [".s", ".S", ".asm"];
...
function main() {
  ...
  console.log(`baremetal-ssg Language Policy Check`);
