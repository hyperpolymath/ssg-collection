...
1. Navigate to [Report a Vulnerability](https://github.com/hyperpolymath/gungir-ssg/security/advisories/new)
...
If you cannot use GitHub Security Advisories, please use GitHub's private vulnerability reporting feature or open a private security advisory.
...
- This repository (`hyperpolymath/gungir-ssg`) and all its code
...
- **GitHub Security Advisories**: Published at [Security Advisories](https://github.com/hyperpolymath/gungir-ssg/security/advisories)
...
When using gungir-ssg, we recommend:
...
- [Security Advisories](https://github.com/hyperpolymath/gungir-ssg/security/advisories)
...
| Purpose | Contact |
|---------|---------|
| **Security issues** | [Report via GitHub](https://github.com/hyperpolymath/gungir-ssg/security/advisories/new) |
| **General questions** | [GitHub Discussions](https://github.com/hyperpolymath/gungir-ssg/discussions) |
...
*Thank you for helping keep gungir-ssg and its users safe.*
