...
[arabic]
. Navigate to
https://github.com/hyperpolymath/gungir-ssg/security/advisories/new[Report
a Vulnerability]
...
If you cannot use GitHub Security Advisories, please use GitHub’s
private vulnerability reporting feature or open a private security
advisory.
...
https://github.com/hyperpolymath/gungir-ssg/security/advisories[Security
Advisories]
...
|*General questions*
|https://github.com/hyperpolymath/gungir-ssg/discussions[GitHub
Discussions]
...
_Thank you for helping keep gungir-ssg and its users safe._
