...
git clone https://github.com/hyperpolymath/gungir-ssg.git cd gungir-ssg
...
toolbox create gungir-ssg-dev toolbox enter gungir-ssg-dev # Install
...
gungir-ssg/ ├── src/ # Source code (Perimeter 1-2) ├── lib/ # Library
