...
git clone https://github.com/hyperpolymath/ssg-collection.git cd
ssg-collection
...
toolbox create ssg-collection-dev toolbox enter ssg-collection-dev #
...
ssg-collection/ ├── src/ # Source code (Perimeter 1-2) ├── lib/ #
