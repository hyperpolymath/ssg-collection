...
git clone https://github.com/hyperpolymath/my-ssg.git cd my-ssg
...
toolbox create my-ssg-dev toolbox enter my-ssg-dev # Install
...
my-ssg/ ├── src/ # Source code (Perimeter 1-2) ├── lib/ # Library code
