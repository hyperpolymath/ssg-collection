...
1. Navigate to [Report a Vulnerability](https://github.com/hyperpolymath/my-ssg/security/advisories/new)
...
- This repository (`hyperpolymath/my-ssg`) and all its code
...
- **GitHub Security Advisories**: Published at [Security Advisories](https://github.com/hyperpolymath/my-ssg/security/advisories)
...
When using my-ssg, we recommend:
...
- [Security Advisories](https://github.com/hyperpolymath/my-ssg/security/advisories)
...
| Purpose | Contact |
|---------|---------|
| **Security issues** | [Report via GitHub](https://github.com/hyperpolymath/my-ssg/security/advisories/new) |
| **General questions** | [GitHub Discussions](https://github.com/hyperpolymath/my-ssg/discussions) |
...
*Thank you for helping keep my-ssg and its users safe.*
