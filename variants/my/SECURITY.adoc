...
[arabic]
. Navigate to
https://github.com/hyperpolymath/my-ssg/security/advisories/new[Report a
Vulnerability]
...
https://github.com/hyperpolymath/my-ssg/security/advisories[Security
Advisories]
...
|Purpose |Contact
|*Security issues*
|https://github.com/hyperpolymath/my-ssg/security/advisories/new[Report
via GitHub]

|*General questions*
|https://github.com/hyperpolymath/my-ssg/discussions[GitHub Discussions]
...
_Thank you for helping keep my-ssg and its users safe._
