...
[arabic]
. Navigate to
https://github.com/hyperpolymath/macrauchenia-ssg/security/advisories/new[Report
a Vulnerability]
...
For non-sensitive security concerns (e.g., documentation improvements,
security hardening suggestions):

* Open an issue at
https://github.com/hyperpolymath/macrauchenia-ssg/issues[GitHub Issues]
* Label it appropriately

____
*Important:* Do not report actual security vulnerabilities through
public GitHub issues, pull requests, discussions, or social media.
____
...
____
*Important:* This safe harbour does not extend to third-party systems.
...
https://github.com/hyperpolymath/macrauchenia-ssg/security/advisories[Security
Advisories]
...
* https://deno.land/manual/runtime/permission_apis[Deno Security Model]
...
|*General questions*
|https://github.com/hyperpolymath/macrauchenia-ssg/discussions[GitHub
Discussions]
...
_Thank you for helping keep macrauchenia-ssg and its users safe._

'''''

Last updated: 2025-12-17 · Policy version: 1.1.0
