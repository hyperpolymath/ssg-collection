...
saur-ssg a harassment-free experience for everyone, regardless of age,
...
. The hyperpolymath Conduct Committee will review the report
...
The hyperpolymath Conduct Committee will follow these guidelines in
...
. *Email* conduct@hyperpolymath.io with subject line "`Appeal: [Original
Report ID]`"
...
* Appeals are reviewed by a different hyperpolymath Conduct Committee
...
* Open a
https://github.com/hyperpolymath/saur-ssg/discussions[Discussion] (for
general questions)
