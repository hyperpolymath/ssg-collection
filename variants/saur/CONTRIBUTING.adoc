...
git clone https://github.com/hyperpolymath/saur-ssg.git cd saur-ssg
...
toolbox create saur-ssg-dev toolbox enter saur-ssg-dev # Install
...
saur-ssg/ ├── src/ # Source code (Perimeter 1-2) ├── lib/ # Library code
