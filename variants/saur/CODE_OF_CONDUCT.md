...
|--------|---------|----------|
| **Email** | conduct@hyperpolymath.io | Detailed reports, sensitive matters |
...
2. The hyperpolymath Conduct Committee will review the report
...
If a hyperpolymath Conduct Committee member is involved in an incident:
...
The hyperpolymath Conduct Committee will follow these guidelines in determining consequences:
...
2. **Email** conduct@hyperpolymath.io with subject line "Appeal: [Original Report ID]"
3. **Explain** why you believe the decision should be reconsidered
4. **Provide** any new information not previously available

**Appeals Process**

- Appeals are reviewed by a different hyperpolymath Conduct Committee member than the original
...
- Open a [Discussion](https://github.com/hyperpolymath/saur-ssg/discussions) (for general questions)
