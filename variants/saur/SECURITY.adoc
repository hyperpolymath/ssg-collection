...
[arabic]
. Navigate to
https://github.com/hyperpolymath/saur-ssg/security/advisories/new[Report
a Vulnerability]
...
|*PGP Key* |https://hyperpolymath.io/.well-known/pgp.asc[Download Public
Key]
...
https://github.com/hyperpolymath/saur-ssg/security/advisories[Security
Advisories]
...
* https://hyperpolymath.io/.well-known/pgp.asc[Our PGP Public Key]
* https://github.com/hyperpolymath/saur-ssg/security/advisories[Security
Advisories]
...
|*Security issues*
|https://github.com/hyperpolymath/saur-ssg/security/advisories/new[Report
via GitHub] or security@hyperpolymath.io

|*General questions*
|https://github.com/hyperpolymath/saur-ssg/discussions[GitHub
Discussions]
...
_Thank you for helping keep saur-ssg and its users safe._ 🛡️
