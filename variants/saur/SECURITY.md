...
1. Navigate to [Report a Vulnerability](https://github.com/hyperpolymath/saur-ssg/security/advisories/new)
...
| | |
|---|---|
| **Email** | security@hyperpolymath.io |
| **PGP Key** | [Download Public Key](https://hyperpolymath.io/.well-known/pgp.asc) |
| **Fingerprint** | `Contact security@hyperpolymath.io for fingerprint` |

```bash
# Import our PGP key
curl -sSL https://hyperpolymath.io/.well-known/pgp.asc | gpg --import

# Verify fingerprint
gpg --fingerprint security@hyperpolymath.io

# Encrypt your report
gpg --armor --encrypt --recipient security@hyperpolymath.io report.txt
```
...
- This repository (`hyperpolymath/saur-ssg`) and all its code
...
- **GitHub Security Advisories**: Published at [Security Advisories](https://github.com/hyperpolymath/saur-ssg/security/advisories)
...
When using saur-ssg, we recommend:
...
- [Our PGP Public Key](https://hyperpolymath.io/.well-known/pgp.asc)
- [Security Advisories](https://github.com/hyperpolymath/saur-ssg/security/advisories)
...
| Purpose | Contact |
|---------|---------|
| **Security issues** | [Report via GitHub](https://github.com/hyperpolymath/saur-ssg/security/advisories/new) or security@hyperpolymath.io |
| **General questions** | [GitHub Discussions](https://github.com/hyperpolymath/saur-ssg/discussions) |
...
*Thank you for helping keep saur-ssg and its users safe.* 🛡️
