...
[arabic]
. Navigate to
https://github.com/hyperpolymath/labnote-ssg/security/advisories/new[Report
a Vulnerability]
...
security issue or contact the maintainers through the repository.
...
https://github.com/hyperpolymath/labnote-ssg/security/advisories[Security
Advisories]
...
|*General questions*
|https://github.com/hyperpolymath/labnote-ssg/discussions[GitHub
Discussions]
...
_Thank you for helping keep labnote-ssg and its users safe._
