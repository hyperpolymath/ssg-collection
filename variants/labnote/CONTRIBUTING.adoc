...
git clone https://github.com/hyperpolymath/labnote-ssg.git cd
labnote-ssg
...
toolbox create labnote-ssg-dev toolbox enter labnote-ssg-dev # Install
...
labnote-ssg/ ├── src/ # Source code (Perimeter 1-2) ├── lib/ # Library
