...
git clone https://github.com/hyperpolymath/jura-ssg.git cd jura-ssg
...
toolbox create jura-ssg-dev toolbox enter jura-ssg-dev # Install
...
jura-ssg/ ├── src/ # Source code (Perimeter 1-2) ├── lib/ # Library code
