...
//
// iota-ssg Language Policy Enforcement
// This SSG MUST be written in APL - no exceptions

const fs = require("fs");
const path = require("path");

const CORE_LANGUAGE = "APL";
const CORE_EXTENSIONS = [".apl", ".dyalog", ".aplf", ".apln", ".aplo"];
...
function checkCoreLanguage() {
  ...
  console.log("   Note: APL uses special Unicode characters (⍳ ⍴ ⌈ ⌊ etc.)");
...
function main() {
  ...
  console.log(`iota-ssg Language Policy Check`);
