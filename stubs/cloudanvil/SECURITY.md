...
1. Navigate to [Report a Vulnerability](https://github.com/hyperpolymath/anvil-ssg/security/advisories/new)
...
If you cannot use GitHub Security Advisories, you may contact the maintainer directly via their [GitHub profile](https://github.com/hyperpolymath).
...
- This repository (`hyperpolymath/anvil-ssg`) and all its code
...
- **GitHub Security Advisories**: Published at [Security Advisories](https://github.com/hyperpolymath/anvil-ssg/security/advisories)
...
When using anvil-ssg, we recommend:
...
- [Security Advisories](https://github.com/hyperpolymath/anvil-ssg/security/advisories)
...
| Purpose | Contact |
|---------|---------|
| **Security issues** | [Report via GitHub](https://github.com/hyperpolymath/anvil-ssg/security/advisories/new) |
| **General questions** | [GitHub Discussions](https://github.com/hyperpolymath/anvil-ssg/discussions) |
...
*Thank you for helping keep anvil-ssg and its users safe.*
