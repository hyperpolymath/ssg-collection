...
|--------|---------|----------|
| **GitHub Issue** | [Open a private security advisory](https://github.com/hyperpolymath/anvil-ssg/security/advisories/new) | Sensitive matters requiring privacy |
| **Private Message** | Contact [@hyperpolymath](https://github.com/hyperpolymath) directly | Quick questions, minor issues |
| **Public Discussion** | [GitHub Discussions](https://github.com/hyperpolymath/anvil-ssg/discussions) | General community concerns |
...
2. **Contact** the maintainers via [GitHub Discussions](https://github.com/hyperpolymath/anvil-ssg/discussions) with subject "Appeal: [Original Report ID]"
...
- Open a [Discussion](https://github.com/hyperpolymath/anvil-ssg/discussions) (for general questions)
