...
anvil-ssg a harassment-free experience for everyone, regardless of age,
...
|*GitHub Issue*
|https://github.com/hyperpolymath/anvil-ssg/security/advisories/new[Open
a private security advisory] |Sensitive matters requiring privacy

|*Private Message* |Contact
https://github.com/hyperpolymath[@hyperpolymath] directly |Quick
questions, minor issues

|*Public Discussion*
|https://github.com/hyperpolymath/anvil-ssg/discussions[GitHub
Discussions] |General community concerns
|===
...
https://github.com/hyperpolymath/anvil-ssg/discussions[GitHub
Discussions] with subject "`Appeal: [Original Report ID]`"
...
* Open a
https://github.com/hyperpolymath/anvil-ssg/discussions[Discussion] (for
general questions)
