...
[arabic]
. Navigate to
https://github.com/hyperpolymath/anvil-ssg/security/advisories/new[Report
a Vulnerability]
...
If you cannot use GitHub Security Advisories, you may contact the
maintainer directly via their https://github.com/hyperpolymath[GitHub
profile].
...
https://github.com/hyperpolymath/anvil-ssg/security/advisories[Security
Advisories]
...
|*General questions*
|https://github.com/hyperpolymath/anvil-ssg/discussions[GitHub
Discussions]
...
_Thank you for helping keep anvil-ssg and its users safe._
