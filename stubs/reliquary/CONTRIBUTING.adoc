...
git clone https://github.com/hyperpolymath/reliquary-ssg.git cd
reliquary-ssg
...
toolbox create reliquary-ssg-dev toolbox enter reliquary-ssg-dev #
...
reliquary-ssg/ ├── src/ # Source code (Perimeter 1-2) ├── lib/ # Library
