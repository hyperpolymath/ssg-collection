...
*Current Version:* 2.0.0 *Last Updated:* 2025-12-22 *Status:* 44/44
Components Complete
...
* [x] Full SCM metadata (META, STATE, ECOSYSTEM, PLAYBOOK, AGENTIC,
NEUROSYM)
...
The MCP adapter in `+adapters/+` is the *only* place where non-Chapel
code is permitted.
...
* https://github.com/hyperpolymath/poly-ssg-mcp[poly-ssg-mcp] - Unified
MCP hub for 28+ SSGs
...
See CONTRIBUTING.md for contribution guidelines. See cookbook.adoc for
complete command reference. For security issues, see SECURITY.md.
