...
[arabic]
. Navigate to
https://github.com/hyperpolymath/parallax-ssg/security/advisories/new[Report
a Vulnerability]
...
https://github.com/hyperpolymath/parallax-ssg/security/advisories[Security
Advisories]
...
|*General questions*
|https://github.com/hyperpolymath/parallax-ssg/discussions[GitHub
Discussions]
...
_Thank you for helping keep parallax-ssg and its users safe._ 🛡️
