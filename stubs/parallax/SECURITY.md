...
1. Navigate to [Report a Vulnerability](https://github.com/hyperpolymath/parallax-ssg/security/advisories/new)
...
| **Fingerprint** | `See key file for fingerprint` |
...
- This repository (`hyperpolymath/parallax-ssg`) and all its code
...
- **GitHub Security Advisories**: Published at [Security Advisories](https://github.com/hyperpolymath/parallax-ssg/security/advisories)
...
When using parallax-ssg, we recommend:
...
- [Security Advisories](https://github.com/hyperpolymath/parallax-ssg/security/advisories)
...
| Purpose | Contact |
|---------|---------|
| **Security issues** | [Report via GitHub](https://github.com/hyperpolymath/parallax-ssg/security/advisories/new) or security@hyperpolymath.org |
| **General questions** | [GitHub Discussions](https://github.com/hyperpolymath/parallax-ssg/discussions) |
...
*Thank you for helping keep parallax-ssg and its users safe.* 🛡️
