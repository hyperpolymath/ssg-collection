...
1. Navigate to [Report a Vulnerability](https://github.com/hyperpolymath/chicxulub--ssg/security/advisories/new)
...
If you cannot use GitHub Security Advisories, you may use [GitHub Discussions](https://github.com/hyperpolymath/chicxulub--ssg/discussions) to request a private channel for reporting.
...
- This repository (`hyperpolymath/chicxulub--ssg`) and all its code
...
- **GitHub Security Advisories**: Published at [Security Advisories](https://github.com/hyperpolymath/chicxulub--ssg/security/advisories)
...
When using chicxulub--ssg, we recommend:
...
- [GitHub Security Advisories](https://github.com/hyperpolymath/chicxulub--ssg/security/advisories)
- [Security Advisories](https://github.com/hyperpolymath/chicxulub--ssg/security/advisories)
...
| Purpose | Contact |
|---------|---------|
| **Security issues** | [Report via GitHub](https://github.com/hyperpolymath/chicxulub--ssg/security/advisories/new) |
| **General questions** | [GitHub Discussions](https://github.com/hyperpolymath/chicxulub--ssg/discussions) |
...
*Thank you for helping keep chicxulub--ssg and its users safe.* 🛡️
