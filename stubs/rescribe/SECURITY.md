...
1. Navigate to [Report a Vulnerability](https://github.com/hyperpolymath/rescribe-ssg/security/advisories/new)
...
| **Fingerprint** | `Contact security@hyperpolymath.org for PGP key` |
...
- This repository (`hyperpolymath/rescribe-ssg`) and all its code
...
- **GitHub Security Advisories**: Published at [Security Advisories](https://github.com/hyperpolymath/rescribe-ssg/security/advisories)
...
When using rescribe-ssg, we recommend:
...
- [Security Advisories](https://github.com/hyperpolymath/rescribe-ssg/security/advisories)
...
| Purpose | Contact |
|---------|---------|
| **Security issues** | [Report via GitHub](https://github.com/hyperpolymath/rescribe-ssg/security/advisories/new) or security@hyperpolymath.org |
| **General questions** | [GitHub Discussions](https://github.com/hyperpolymath/rescribe-ssg/discussions) |
...
*Thank you for helping keep rescribe-ssg and its users safe.* 🛡️
