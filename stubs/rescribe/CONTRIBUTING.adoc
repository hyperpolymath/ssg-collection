...
git clone https://github.com/hyperpolymath/rescribe-ssg.git cd
rescribe-ssg
...
toolbox create rescribe-ssg-dev toolbox enter rescribe-ssg-dev # Install
...
rescribe-ssg/ ├── src/ # Source code (Perimeter 1-2) ├── lib/ # Library
