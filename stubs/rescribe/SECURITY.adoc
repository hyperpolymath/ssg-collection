...
[arabic]
. Navigate to
https://github.com/hyperpolymath/rescribe-ssg/security/advisories/new[Report
a Vulnerability]
...
|*PGP Key* |https://hyperpolymath.org/gpg/security.asc[Download Public
Key]
...
https://github.com/hyperpolymath/rescribe-ssg/security/advisories[Security
Advisories]
...
* https://hyperpolymath.org/gpg/security.asc[Our PGP Public Key]
* https://github.com/hyperpolymath/rescribe-ssg/security/advisories[Security
Advisories]
...
|*General questions*
|https://github.com/hyperpolymath/rescribe-ssg/discussions[GitHub
Discussions]
...
_Thank you for helping keep rescribe-ssg and its users safe._ 🛡️
