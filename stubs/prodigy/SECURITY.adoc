...
[arabic]
. Navigate to
https://github.com/hyperpolymath/prodigy-ssg/security/advisories/new[Report
a Vulnerability]
...
https://github.com/hyperpolymath/prodigy-ssg/security/advisories[Security
Advisories]
...
|*General questions*
|https://github.com/hyperpolymath/prodigy-ssg/discussions[GitHub
Discussions]
...
_Thank you for helping keep prodigy-ssg and its users safe._ 🛡️
