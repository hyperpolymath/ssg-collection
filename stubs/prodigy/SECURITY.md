...
1. Navigate to [Report a Vulnerability](https://github.com/hyperpolymath/prodigy-ssg/security/advisories/new)
...
| **Fingerprint** | `Contact security@hyperpolymath.org for fingerprint` |
...
- This repository (`hyperpolymath/prodigy-ssg`) and all its code
...
- **GitHub Security Advisories**: Published at [Security Advisories](https://github.com/hyperpolymath/prodigy-ssg/security/advisories)
...
When using prodigy-ssg, we recommend:
...
- [Security Advisories](https://github.com/hyperpolymath/prodigy-ssg/security/advisories)
...
| Purpose | Contact |
|---------|---------|
| **Security issues** | [Report via GitHub](https://github.com/hyperpolymath/prodigy-ssg/security/advisories/new) or security@hyperpolymath.org |
| **General questions** | [GitHub Discussions](https://github.com/hyperpolymath/prodigy-ssg/discussions) |
...
*Thank you for helping keep prodigy-ssg and its users safe.* 🛡️
