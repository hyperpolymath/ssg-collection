...
git clone https://github.com/hyperpolymath/prodigy-ssg.git cd
prodigy-ssg
...
toolbox create prodigy-ssg-dev toolbox enter prodigy-ssg-dev # Install
...
prodigy-ssg/ ├── src/ # Source code (Perimeter 1-2) ├── lib/ # Library
