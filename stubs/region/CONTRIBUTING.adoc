...
git clone https://github.com/hyperpolymath/region-ssg.git cd region-ssg
...
toolbox create region-ssg-dev toolbox enter region-ssg-dev # Install
...
region-ssg/ ├── src/ # Source code (Perimeter 1-2) ├── lib/ # Library
