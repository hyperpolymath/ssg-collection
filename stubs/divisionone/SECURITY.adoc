...
[arabic]
. Navigate to
https://github.com/hyperpolymath/divisionone-ssg/security/advisories/new[Report
a Vulnerability]
...
https://github.com/hyperpolymath/divisionone-ssg/security/advisories[Security
Advisories]
...
|*General questions*
|https://github.com/hyperpolymath/divisionone-ssg/discussions[GitHub
Discussions]
...
_Thank you for helping keep Division One SSG and its users safe._
