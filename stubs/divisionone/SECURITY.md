...
1. Navigate to [Report a Vulnerability](https://github.com/hyperpolymath/divisionone-ssg/security/advisories/new)
...
- This repository (`hyperpolymath/divisionone-ssg`) and all its code
...
- **GitHub Security Advisories**: Published at [Security Advisories](https://github.com/hyperpolymath/divisionone-ssg/security/advisories)
...
When using Division One SSG, we recommend:
...
- [Security Advisories](https://github.com/hyperpolymath/divisionone-ssg/security/advisories)
...
| Purpose | Contact |
|---------|---------|
| **Security issues** | [Report via GitHub](https://github.com/hyperpolymath/divisionone-ssg/security/advisories/new) |
| **General questions** | [GitHub Discussions](https://github.com/hyperpolymath/divisionone-ssg/discussions) |
...
*Thank you for helping keep Division One SSG and its users safe.*
