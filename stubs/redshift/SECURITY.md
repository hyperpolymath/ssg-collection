...
1. Navigate to [Report a Vulnerability](https://github.com/hyperpolymath/shift-ssg/security/advisories/new)
...
- This repository (`hyperpolymath/shift-ssg`) and all its code
...
- **GitHub Security Advisories**: Published at [Security Advisories](https://github.com/hyperpolymath/shift-ssg/security/advisories)
...
When using Shift SSG, we recommend:
...
- [Security Advisories](https://github.com/hyperpolymath/shift-ssg/security/advisories)
...
| Purpose | Contact |
|---------|---------|
| **Security issues** | [Report via GitHub](https://github.com/hyperpolymath/shift-ssg/security/advisories/new) or security@hyperpolymath.dev |
| **General questions** | [GitHub Discussions](https://github.com/hyperpolymath/shift-ssg/discussions) |
...
*Thank you for helping keep Shift SSG and its users safe.* 🛡️
