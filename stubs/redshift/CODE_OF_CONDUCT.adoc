...
Shift SSG a harassment-free experience for everyone, regardless of age,
...
. The Code of Conduct Team will review the report
...
The Code of Conduct Team will follow these guidelines in determining
consequences:
...
. *Email* conduct@hyperpolymath.dev with subject line "`Appeal:
[Original Report ID]`"
...
* Appeals are reviewed by a different Code of Conduct Team member than
the original
...
* Open a
https://github.com/hyperpolymath/shift-ssg/discussions[Discussion] (for
general questions)
