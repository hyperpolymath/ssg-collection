...
[arabic]
. Navigate to
https://github.com/hyperpolymath/shift-ssg/security/advisories/new[Report
a Vulnerability]
...
https://github.com/hyperpolymath/shift-ssg/security/advisories[Security
Advisories]
...
|*Security issues*
|https://github.com/hyperpolymath/shift-ssg/security/advisories/new[Report
via GitHub] or security@hyperpolymath.dev

|*General questions*
|https://github.com/hyperpolymath/shift-ssg/discussions[GitHub
Discussions]
...
_Thank you for helping keep Shift SSG and its users safe._ 🛡️
