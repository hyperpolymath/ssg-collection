...
git clone https://github.com/hyperpolymath/redshift-ssg.git cd
redshift-ssg
...
toolbox create redshift-ssg-dev toolbox enter redshift-ssg-dev # Install
...
redshift-ssg/ ├── src/ # Source code (Perimeter 1-2) ├── lib/ # Library
