...
git clone https://github.com/hyperpolymath/shift-ssg.git cd shift-ssg
...
toolbox create shift-ssg-dev toolbox enter shift-ssg-dev # Install
...
shift-ssg/ ├── src/ # Source code (Perimeter 1-2) ├── lib/ # Library
