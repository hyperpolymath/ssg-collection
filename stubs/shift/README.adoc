...
shift-ssg is a static site generator written in https://wren.io/[Wren],
a small, fast, class-based scripting language. It uses Wren’s elegant
class system and fiber-based concurrency for clean, composable site
generation.
...
* *Markdown processing* - Convert Markdown to HTML with frontmatter
parsing
...
* https://wren.io/cli/[Wren CLI] or embedded Wren runtime
...
This SSG is part of the
https://github.com/hyperpolymath/poly-ssg-mcp[poly-ssg-mcp] polyglot SSG
ecosystem.
