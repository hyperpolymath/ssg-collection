...
Replace all {{PLACEHOLDER}} values with your information:
  Ssg Collection     - Your project name
  hyperpolymath            - GitHub username or org (e.g., hyperpolymath)
  ssg-collection             - Repository name
...
1. Navigate to [Report a Vulnerability](https://github.com/hyperpolymath/ssg-collection/security/advisories/new)
...
- This repository (`hyperpolymath/ssg-collection`) and all its code
...
- **GitHub Security Advisories**: Published at [Security Advisories](https://github.com/hyperpolymath/ssg-collection/security/advisories)
...
When using Ssg Collection, we recommend:
...
- [Security Advisories](https://github.com/hyperpolymath/ssg-collection/security/advisories)
...
| Purpose | Contact |
|---------|---------|
| **Security issues** | [Report via GitHub](https://github.com/hyperpolymath/ssg-collection/security/advisories/new) or 6759885+hyperpolymath@users.noreply.github.com |
| **General questions** | [GitHub Discussions](https://github.com/hyperpolymath/ssg-collection/discussions) |
...
*Thank you for helping keep Ssg Collection and its users safe.* 🛡️
