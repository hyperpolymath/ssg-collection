...
git clone https://github.com/hyperpolymath/pharos-ssg.git cd pharos-ssg
...
toolbox create pharos-ssg-dev toolbox enter pharos-ssg-dev # Install
...
pharos-ssg/ ├── src/ # Source code (Perimeter 1-2) ├── lib/ # Library
