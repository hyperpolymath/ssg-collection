...
git clone https://github.com/hyperpolymath/rats-ssg.git cd rats-ssg
...
toolbox create rats-ssg-dev toolbox enter rats-ssg-dev # Install
...
rats-ssg/ ├── src/ # Source code (Perimeter 1-2) ├── lib/ # Library code
