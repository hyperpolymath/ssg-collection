...
1. Navigate to [Report a Vulnerability](https://github.com/hyperpolymath/rats-ssg/security/advisories/new)
...
If you cannot use GitHub Security Advisories, you may reach out via [GitHub Discussions](https://github.com/hyperpolymath/rats-ssg/discussions) to request a private channel.
...
- This repository (`hyperpolymath/rats-ssg`) and all its code
...
- **GitHub Security Advisories**: Published at [Security Advisories](https://github.com/hyperpolymath/rats-ssg/security/advisories)
...
When using rats-ssg, we recommend:
...
- [Security Advisories](https://github.com/hyperpolymath/rats-ssg/security/advisories)
...
| Purpose | Contact |
|---------|---------|
| **Security issues** | [Report via GitHub](https://github.com/hyperpolymath/rats-ssg/security/advisories/new) |
| **General questions** | [GitHub Discussions](https://github.com/hyperpolymath/rats-ssg/discussions) |
...
*Thank you for helping keep rats-ssg and its users safe.* 🛡️
