...
[arabic]
. Navigate to
https://github.com/hyperpolymath/rats-ssg/security/advisories/new[Report
a Vulnerability]
...
If you cannot use GitHub Security Advisories, you may reach out via
https://github.com/hyperpolymath/rats-ssg/discussions[GitHub
Discussions] to request a private channel.
...
https://github.com/hyperpolymath/rats-ssg/security/advisories[Security
Advisories]
...
_Thank you for helping keep rats-ssg and its users safe._ 🛡️
