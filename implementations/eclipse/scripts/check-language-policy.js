...
//
// eclipse-ssg Language Policy Enforcement
// This SSG MUST be written in Pony - no exceptions

const fs = require("fs");
const path = require("path");

const CORE_LANGUAGE = "Pony";
const CORE_EXTENSIONS = [".pony"];
...
function main() {
  ...
  console.log(`eclipse-ssg Language Policy Check`);
