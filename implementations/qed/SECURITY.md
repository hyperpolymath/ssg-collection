...
1. Navigate to [Report a Vulnerability](https://github.com/hyperpolymath/qed-ssg/security/advisories/new)
...
### Alternative: GitHub Discussions (Private)

If you cannot use GitHub Security Advisories, you may open a private discussion or contact the maintainers through the channels listed in the README.

> **⚠️ Important:** Do not report security vulnerabilities through public GitHub issues, pull requests, or social media.
...
- This repository (`hyperpolymath/qed-ssg`) and all its code
...
- **GitHub Security Advisories**: Published at [Security Advisories](https://github.com/hyperpolymath/qed-ssg/security/advisories)
...
When using qed-ssg, we recommend:
...
- [Security Advisories](https://github.com/hyperpolymath/qed-ssg/security/advisories)
...
| Purpose | Contact |
|---------|---------|
| **Security issues** | [Report via GitHub](https://github.com/hyperpolymath/qed-ssg/security/advisories/new) |
| **General questions** | [GitHub Discussions](https://github.com/hyperpolymath/qed-ssg/discussions) |
...
*Thank you for helping keep qed-ssg and its users safe.* 🛡️
