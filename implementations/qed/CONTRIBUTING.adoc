...
git clone https://github.com/hyperpolymath/qed-ssg.git cd qed-ssg
...
toolbox create qed-ssg-dev toolbox enter qed-ssg-dev # Install
...
qed-ssg/ ├── src/ # Source code (Perimeter 1-2) ├── lib/ # Library code
