...
[arabic]
. Navigate to
https://github.com/hyperpolymath/qed-ssg/security/advisories/new[Report
a Vulnerability]
...
If you cannot use GitHub Security Advisories, you may open a private
discussion or contact the maintainers through the channels listed in the
README.

____
*⚠️ Important:* Do not report security vulnerabilities through public
GitHub issues, pull requests, or social media.
____
...
https://github.com/hyperpolymath/qed-ssg/security/advisories[Security
Advisories]
...
|*General questions*
|https://github.com/hyperpolymath/qed-ssg/discussions[GitHub
Discussions]
...
_Thank you for helping keep qed-ssg and its users safe._ 🛡️
