...
git clone https://github.com/hyperpolymath/hackenbush-ssg.git cd
hackenbush-ssg
...
toolbox create hackenbush-ssg-dev toolbox enter hackenbush-ssg-dev #
...
hackenbush-ssg/ ├── src/ # Source code (Perimeter 1-2) ├── lib/ #
