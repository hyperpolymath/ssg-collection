...
git clone https://github.com/hyperpolymath/odd-ssg.git cd odd-ssg
...
toolbox create odd-ssg-dev toolbox enter odd-ssg-dev # Install
...
odd-ssg/ ├── src/ # Source code (Perimeter 1-2) ├── lib/ # Library code
