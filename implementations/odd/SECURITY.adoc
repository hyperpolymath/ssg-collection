...
[arabic]
. Navigate to
https://github.com/hyperpolymath/odd-ssg/security/advisories/new[Report
a Vulnerability]
...
https://github.com/hyperpolymath/odd-ssg/security/advisories[Security
Advisories]
...
|*General questions*
|https://github.com/hyperpolymath/odd-ssg/discussions[GitHub
Discussions]
...
_Thank you for helping keep odd-ssg and its users safe._ 🛡️
