...
= Contributing — ssg-collection
:revdate: 2026-MM-DD

== Audience

Developers working *on* `ssg-collection`. For consumers (people calling
...
[source,bash]
----
git clone git@github.com:hyperpolymath/ssg-collection.git
cd ssg-collection
...
* Bugs in `ssg-collection`: file at `hyperpolymath/ssg-collection/issues`.
