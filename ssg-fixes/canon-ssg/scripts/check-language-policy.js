...
//
// canon-ssg Language Policy Enforcement
// This SSG MUST be written in Standard ML - no exceptions

const fs = require("fs");
const path = require("path");

const CORE_LANGUAGE = "Standard ML";
const CORE_EXTENSIONS = [".sml", ".sig", ".mlb", ".cm"];
...
function main() {
  ...
  console.log(`canon-ssg Language Policy Check`);
