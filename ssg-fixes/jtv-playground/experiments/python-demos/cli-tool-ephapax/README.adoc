...
Same functionality as Python version: - JSON operations (format,
validate, minify) - File operations (count, size, lines) - Text
operations (encode, decode, upper, lower) - Hash operations (md5, sha1,
sha256, sha512) - Search with regex patterns
