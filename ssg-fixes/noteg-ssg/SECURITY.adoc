...
[arabic]
. Navigate to
https://github.com/hyperpolymath/noteg-ssg/security/advisories/new[Report
a Vulnerability]
...
at the email address listed in the repository profile.
...
https://github.com/hyperpolymath/noteg-ssg/security/advisories[Security
Advisories]
...
|*General questions*
|https://github.com/hyperpolymath/noteg-ssg/discussions[GitHub
Discussions]
...
_Thank you for helping keep noteg-ssg and its users safe._
