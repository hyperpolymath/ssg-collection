...
-- "Notes that compute" - content as executable specifications
--
-- This package provides the core SSG engine in Ada, emphasizing
-- strong typing, formal verification, and compile-time correctness.
