...
package body Noteg_Engine is
   ...
   begin
      ...
      Put_Line ("noteg-ssg: Building site '" & To_String (S.Name) & "'...");
      Put_Line ("noteg-ssg: Output directory: " & Out_Dir);
      ...
      for P of S.Pages loop
         ...
         begin
            ...
            Put_Line ("noteg-ssg: Built " & Out_Path);
         end;
      end loop;

      Put_Line ("noteg-ssg: Built " & S.Pages.Length'Image & " pages");
   end Build_Site;
