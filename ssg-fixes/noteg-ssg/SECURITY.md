...
1. Navigate to [Report a Vulnerability](https://github.com/hyperpolymath/noteg-ssg/security/advisories/new)
...
If you cannot use GitHub Security Advisories, you may email us directly at the email address listed in the repository profile.
...
- This repository (`hyperpolymath/noteg-ssg`) and all its code
...
- Significant logic flaws in adapter implementations
...
- **GitHub Security Advisories**: Published at [Security Advisories](https://github.com/hyperpolymath/noteg-ssg/security/advisories)
...
When using noteg-ssg, we recommend:
...
- [Security Advisories](https://github.com/hyperpolymath/noteg-ssg/security/advisories)
...
| Purpose | Contact |
|---------|---------|
| **Security issues** | [Report via GitHub](https://github.com/hyperpolymath/noteg-ssg/security/advisories/new) |
| **General questions** | [GitHub Discussions](https://github.com/hyperpolymath/noteg-ssg/discussions) |
...
*Thank you for helping keep noteg-ssg and its users safe.*
