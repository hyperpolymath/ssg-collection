...
git clone https://github.com/hyperpolymath/noteg-ssg.git cd noteg-ssg
...
toolbox create noteg-ssg-dev toolbox enter noteg-ssg-dev # Install
...
noteg-ssg/ ├── src/ # Source code (Perimeter 1-2) ├── lib/ # Library
