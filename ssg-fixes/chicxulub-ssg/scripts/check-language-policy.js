...
//
// chicxulub-ssg Language Policy Enforcement
// This SSG MUST be written in Bash - no exceptions

const fs = require("fs");
const path = require("path");

const CORE_LANGUAGE = "Bash";
const CORE_EXTENSIONS = [".bash", ".sh"];
...
function main() {
  ...
  console.log(`chicxulub-ssg Language Policy Check`);
