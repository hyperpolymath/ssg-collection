...
[arabic]
. Navigate to
link:++https://github.com/hyperpolymath/chicxulub--ssg/security/advisories/new++[Report
a Vulnerability]
...
If you cannot use GitHub Security Advisories, you may use
link:++https://github.com/hyperpolymath/chicxulub--ssg/discussions++[GitHub
Discussions] to request a private channel for reporting.
...
link:++https://github.com/hyperpolymath/chicxulub--ssg/security/advisories++[Security
Advisories]
...
* link:++https://github.com/hyperpolymath/chicxulub--ssg/security/advisories++[GitHub
Security Advisories]
* link:++https://github.com/hyperpolymath/chicxulub--ssg/security/advisories++[Security
Advisories]
...
_Thank you for helping keep chicxulub–ssg and its users safe._ 🛡️
