...
[arabic]
. Navigate to
https://github.com/hyperpolymath/iota-ssg/security/advisories/new[Report
a Vulnerability]
...
issue or contact the maintainers through GitHub.
...
https://github.com/hyperpolymath/iota-ssg/security/advisories[Security
Advisories]
...
|*General questions*
|https://github.com/hyperpolymath/iota-ssg/discussions[GitHub
Discussions]
...
_Thank you for helping keep iota-ssg and its users safe._
