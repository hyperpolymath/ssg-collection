...
iota-ssg a harassment-free experience for everyone, regardless of age,
...
|*GitHub* |Open a private security advisory or contact maintainers
|Detailed reports, sensitive matters
...
. The Core Maintainers will review the report
...
The Core Maintainers will follow these guidelines in determining
consequences:
...
. *Contact maintainers* with subject line "`Appeal: [Original Report
ID]`"
...
* Appeals are reviewed by a different Core Maintainers member than the
original
