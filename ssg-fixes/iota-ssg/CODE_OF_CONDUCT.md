...
|--------|---------|----------|
| **GitHub** | Open a private security advisory or contact maintainers | Detailed reports, sensitive matters |
...
2. The Core Maintainers will review the report
...
If a Core Maintainers member is involved in an incident:
...
The Core Maintainers will follow these guidelines in determining consequences:
...
2. **Contact maintainers** with subject line "Appeal: [Original Report ID]"
3. **Explain** why you believe the decision should be reconsidered
4. **Provide** any new information not previously available

**Appeals Process**

- Appeals are reviewed by a different Core Maintainers member than the original
...
- Open a [Discussion](https://github.com/hyperpolymath/iota-ssg/discussions) (for general questions)
