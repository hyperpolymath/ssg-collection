...
1. Navigate to [Report a Vulnerability](https://github.com/hyperpolymath/iota-ssg/security/advisories/new)
...
If you cannot use GitHub Security Advisories, you may open a private issue or contact the maintainers through GitHub.
...
- This repository (`hyperpolymath/iota-ssg`) and all its code
...
- **GitHub Security Advisories**: Published at [Security Advisories](https://github.com/hyperpolymath/iota-ssg/security/advisories)
...
When using iota-ssg, we recommend:
...
- [Security Advisories](https://github.com/hyperpolymath/iota-ssg/security/advisories)
...
| Purpose | Contact |
|---------|---------|
| **Security issues** | [Report via GitHub](https://github.com/hyperpolymath/iota-ssg/security/advisories/new) |
| **General questions** | [GitHub Discussions](https://github.com/hyperpolymath/iota-ssg/discussions) |
...
*Thank you for helping keep iota-ssg and its users safe.*
