...
[arabic]
. Navigate to
https://github.com/hyperpolymath/zigzag-ssg/security/advisories/new[Report
a Vulnerability]
...
For non-critical security concerns, you may open a private security
issue via GitHub Security Advisories. For critical vulnerabilities,
always use the Security Advisory feature above.
...
https://github.com/hyperpolymath/zigzag-ssg/security/advisories[Security
Advisories]
...
|*General questions*
|https://github.com/hyperpolymath/zigzag-ssg/discussions[GitHub
Discussions]
...
_Thank you for helping keep zigzag-ssg and its users safe._
