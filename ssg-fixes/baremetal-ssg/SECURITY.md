...
1. Navigate to [Report a Vulnerability](https://github.com/hyperpolymath/baremetal-ssg/security/advisories/new)
...
> **Important:** Do not report security vulnerabilities through public GitHub issues, pull requests, discussions, or social media. Use the GitHub Security Advisories feature above.
...
- This repository (`hyperpolymath/baremetal-ssg`) and all its code
...
- **GitHub Security Advisories**: Published at [Security Advisories](https://github.com/hyperpolymath/baremetal-ssg/security/advisories)
...
When using baremetal-ssg, we recommend:
...
- [Security Advisories](https://github.com/hyperpolymath/baremetal-ssg/security/advisories)
...
| Purpose | Contact |
|---------|---------|
| **Security issues** | [Report via GitHub](https://github.com/hyperpolymath/baremetal-ssg/security/advisories/new) |
| **General questions** | [GitHub Discussions](https://github.com/hyperpolymath/baremetal-ssg/discussions) |
...
*Thank you for helping keep baremetal-ssg and its users safe.* 🛡️
