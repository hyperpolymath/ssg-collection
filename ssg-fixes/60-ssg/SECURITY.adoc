...
[arabic]
. Navigate to
https://github.com/hyperpolymath/template-repo/security/advisories/new[Report
a Vulnerability]
...
For non-sensitive security concerns that don’t require confidential
disclosure, you may open a regular GitHub issue with the `+security+`
label.
...
https://github.com/hyperpolymath/template-repo/security/advisories[Security
Advisories]
...
|*General questions*
|https://github.com/hyperpolymath/template-repo/discussions[GitHub
Discussions]
...
_Thank you for helping keep template-repo and its users safe._ 🛡️
