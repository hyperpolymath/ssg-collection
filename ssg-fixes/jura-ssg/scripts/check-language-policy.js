...
//
// jura-ssg Language Policy Enforcement
// This SSG MUST be written in J - no exceptions

const fs = require("fs");
const path = require("path");

const CORE_LANGUAGE = "J";
const CORE_EXTENSIONS = [".ijs", ".ijt", ".ijp"];
...
function checkCoreLanguage() {
  ...
  console.log("   Note: J is an array programming language descended from APL");
...
function main() {
  ...
  console.log(`jura-ssg Language Policy Check`);
