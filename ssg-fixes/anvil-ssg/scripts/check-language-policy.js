...
//
// anvil-ssg Language Policy Enforcement
// This SSG MUST be written in Ada/SPARK - no exceptions

const fs = require("fs");
const path = require("path");

const CORE_LANGUAGE = "Ada/SPARK";
const CORE_EXTENSIONS = [".adb", ".ads", ".gpr"];
...
function main() {
  ...
  console.log(`anvil-ssg Language Policy Check`);
