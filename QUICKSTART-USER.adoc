...
// Replace ssg-collection, Ssg Collection — See README.adoc for details., just run, Ssg Collection started successfully. with actuals
= ssg-collection — Quick Start for Users
:toc:
:toclevels: 2

== What is ssg-collection?

Ssg Collection — See README.adoc for details.
...
[source,bash]
----
just install --portable --prefix=./ssg-collection-portable
----
...
[source]
----
Ssg Collection started successfully.
----
...
* **Wiki**: https://github.com/hyperpolymath/ssg-collection/wiki
